        ...
        <div className="row">
            <div className="col-10 col-sm-8 col-md-8 col-lg-6 col-xl-6 mx-auto mt-5">
                ...
                <div className="form-group">
                    ...
                    <button type="submit" disabled={auth.isLoading} className="btn btn-primary btn-lg mr-3" onClick={handleSignUpAdmin}>Submit</button>
...
const mapDispatchToProps = (dispatch) => ({
    signupAdmin: (email, password, name) => { dispatch(authActions.signupAdmin(email, password, name)); },
